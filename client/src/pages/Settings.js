    ...
    <>
      ...
      <div className="settings-grid">
        ...
        <div className="card">
          ...
          <div className="kv-row"><span className="k">CareDesk EHR version</span><span className="v">v2.5.0</span></div>
          <div className="kv-row"><span className="k">Database connection</span><span className="v v-ok">{serverConnected ? 'Connected' : 'Disconnected — check the server'}</span></div>
      ...
      <div className="card">
        ...
        <p style={{ color: 'var(--text-muted)', fontSize: 13, margin: '0 0 4px' }}>
          How your ESP32 + R307/AS608 sensor talks to this dashboard's Express API backend.
        </p>
        <div className="flow-diagram">
          ...
          <div className="flow-node">Database lookup by template</div><span className="flow-arrow">→</span>
